...
export default function AnalysisResult({
  ...
  const whatsappMessage = `Merhaba, ${url} adresli sitem için ${score} puan aldığım analiz sonucunu görüşmek istiyorum.`;
        ...
        <div className="relative grid gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex h-13 w-fit items-center justify-center gap-2.5 rounded-full border border-white/16 bg-white/[0.035] px-6 text-[0.78rem] font-medium uppercase tracking-[0.16em] text-white/82 transition duration-300 ease-out hover:-translate-y-0.5 hover:border-white/28 hover:bg-white/[0.06] hover:text-white"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
